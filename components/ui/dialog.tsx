  ...
  return (
    <DialogPortalPrimitive>
      ...
      <DialogContentPrimitive
        className={cn(
          'bg-background/70 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-3xl border p-6 shadow-lg backdrop-blur-sm sm:max-w-lg',
          className
        )}
        {...props}
      >
...
function DialogFooter({ className, ...props }: DialogFooterProps) {
  return <DialogFooterPrimitive className={cn('flex flex-col-reverse gap-2 sm:flex-row sm:justify-end', className)} {...props} />;
}
