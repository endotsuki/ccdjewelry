  ...
  return (
    <input
      ...
      className={cn(
        ...
        'focus-visible:border-none focus-visible:ring-ring/50 focus-visible:ring-[3px] transition-colors duration-200',
        'aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-colors duration-200',
